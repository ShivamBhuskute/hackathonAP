...
export default function CoordinatorRegistration({ navigation }) {
  ...
  const handleRegistration = () => {
    if (!name || !email || !password || !confirmPassword || !contactNumber || !collegeName || !coordinatorId) {
    ...
    Alert.alert('Success', 'Registration completed successfully.', [
      {
        text: 'OK',
        onPress: () => navigation.navigate('CoordinatorsDashboard'), // Navigate to StudentDashboardApp after registration
      },
    ]);
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Animated.Text style={[styles.title, { opacity: fadeAnim }]}>Coordinator Registration</Animated.Text>
