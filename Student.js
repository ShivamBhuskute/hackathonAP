...
export default function StudentRegistration() {
  ...
  const handleRegistration = () => {
    if (!name || !email || !password || !confirmPassword || !contactNumber || !department || !collegeName || !studentId) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Animated.Text style={[styles.title, { opacity: fadeAnim }]}>Student Registration</Animated.Text>
